...
public class UsuarioLogic implements IUsuarioLogic {
    ...
    */
    ...
    public void saveUsuario(Usuario entity) throws Exception {
        ...
        try {
            if ((entity.getUsuarioAdmin() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getUsuarioAdmin(), 1) == false)) {
            ...
            if ((entity.getUsuarioImagen() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getUsuarioImagen(), 20) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "usuarioImagen");
            }
            ...
            if ((entity.getUsuarioNombre() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getUsuarioNombre(), 20) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "usuarioNombre");
            }

            if (entity.getUsuarioPasswd() == null) {
                throw new ZMessManager().new EmptyFieldException(
                    "usuarioPasswd");
            }
            ...
            if ((entity.getUsuarioPasswd() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getUsuarioPasswd(), 20) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "usuarioPasswd");
            }

            if (getUsuario(entity.getUsuarioId()) != null) {
    ...
    public void deleteUsuario(Usuario entity) throws Exception {
        ...
        try {
            colaboradors = colaboradorDAO.findByProperty("usuario.usuarioId",
                    entity.getUsuarioId());

            if (Utilities.validationsList(colaboradors) == true) {
                throw new ZMessManager().new DeletingException("colaboradors");
            }

            miembros = miembroDAO.findByProperty("usuario.usuarioId",
                    entity.getUsuarioId());

            if (Utilities.validationsList(miembros) == true) {
                throw new ZMessManager().new DeletingException("miembros");
            }
    ...
    public List<UsuarioDTO> getDataUsuario() throws Exception {
        try {
            ...
            for (Usuario usuarioTmp : usuario) {
                ...
                usuarioDTO2.setUsuarioId(usuarioTmp.getUsuarioId());
                usuarioDTO2.setUsuarioAdmin((usuarioTmp.getUsuarioAdmin() != null)
                    ? usuarioTmp.getUsuarioAdmin() : null);
                usuarioDTO2.setUsuarioFechaCreacion(usuarioTmp.getUsuarioFechaCreacion());
                usuarioDTO2.setUsuarioFechaModificacion(usuarioTmp.getUsuarioFechaModificacion());
                usuarioDTO2.setUsuarioImagen((usuarioTmp.getUsuarioImagen() != null)
                    ? usuarioTmp.getUsuarioImagen() : null);
                usuarioDTO2.setUsuarioNombre((usuarioTmp.getUsuarioNombre() != null)
                    ? usuarioTmp.getUsuarioNombre() : null);
                usuarioDTO2.setUsuarioPasswd((usuarioTmp.getUsuarioPasswd() != null)
                    ? usuarioTmp.getUsuarioPasswd() : null);
    ...
    public Usuario getUsuario(Integer usuarioId) throws Exception {
        ...
        try {
            entity = usuarioDAO.findById(usuarioId);
        } catch (Exception e) {
