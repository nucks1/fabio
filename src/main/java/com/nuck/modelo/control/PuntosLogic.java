...
@Scope("singleton")
@Service("PuntosLogic")
public class PuntosLogic implements IPuntosLogic {
    private static final Logger log = LoggerFactory.getLogger(PuntosLogic.class);
    ...
    */
    ...
    public void savePuntos(Puntos entity) throws Exception {
        ...
        try {
            ...
            if (entity.getPuntosId() == null) {
                throw new ZMessManager().new EmptyFieldException("puntosId");
            }
            ...
            if (getPuntos(entity.getPuntosId()) != null) {
                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
            }

            puntosDAO.save(entity);
    ...
    public List<PuntosDTO> getDataPuntos() throws Exception {
        try {
            ...
            for (Puntos puntosTmp : puntos) {
                PuntosDTO puntosDTO2 = new PuntosDTO();

                puntosDTO2.setPuntosId(puntosTmp.getPuntosId());
                puntosDTO2.setPuntosPuntos((puntosTmp.getPuntosPuntos() != null)
                    ? puntosTmp.getPuntosPuntos() : null);
                puntosDTO2.setClaseTipoId_ClaseTipo((puntosTmp.getClaseTipo()
                                                              .getClaseTipoId() != null)
                    ? puntosTmp.getClaseTipo().getClaseTipoId() : null);
    ...
    public Puntos getPuntos(Integer puntosId) throws Exception {
        ...
        try {
            entity = puntosDAO.findById(puntosId);
        } catch (Exception e) {
    ...
    public List<Puntos> findPagePuntos(String sortColumnName,
        ...
        try {
            entity = puntosDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Puntos> findByCriteria(Object[] variables,
        ...
        try {
            list = puntosDAO.findByCriteria(where);
        } catch (Exception e) {
